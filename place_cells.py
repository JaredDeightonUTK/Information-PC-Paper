...
# =============================================================================
#         center_x = np.random.uniform(-self.box_width/2, self.box_width/2)
#         center_y = np.random.uniform(-self.box_width/2, self.box_width/2)
#         
#         # Replicate the center for all place cells
#         usx = np.full((self.Np,), center_x)
#         usy = np.full((self.Np,), center_y)
#         
# =============================================================================
        ####################################################################################################
